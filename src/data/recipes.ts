...
export const recipes: Recipe[] = [
  r('masala-omelette', 'Masala Omelette', 'indian', ['breakfast'], 5, 8, ['quick', 'one_pan', 'protein'],
    [{ name: 'egg', quantity: '4' }, { name: 'onion', quantity: '1 small' }, { name: 'tomato', quantity: '1' }, { name: 'chili', quantity: '1' }, { name: 'salt' }, { name: 'pepper' }, { name: 'oil', quantity: '1 tbsp' }],
  ...
  r('poha', 'Poha (Flattened Rice)', 'indian', ['breakfast'], 10, 10, ['quick', 'vegetarian', 'one_pan'],
    [{ name: 'rice', quantity: '2 cups poha' }, { name: 'onion', quantity: '1' }, { name: 'potato', quantity: '1 small' }, { name: 'peanut', quantity: '2 tbsp', optional: true }, { name: 'turmeric' }, { name: 'lemon' }, { name: 'oil' }, { name: 'salt' }],
  ...
  r('upma', 'Rava Upma', 'indian', ['breakfast'], 5, 15, ['quick', 'vegetarian'],
    [{ name: 'flour', quantity: '1 cup semolina' }, { name: 'onion', quantity: '1' }, { name: 'carrot', quantity: '1', optional: true }, { name: 'beans', quantity: 'handful', optional: true }, { name: 'mustard seeds' }, { name: 'oil' }, { name: 'salt' }],
  ...
  r('idli-sambar', 'Quick Idli with Sambar', 'indian', ['breakfast'], 10, 20, ['south_indian', 'vegetarian'],
    [{ name: 'lentil', quantity: '1/2 cup toor dal' }, { name: 'tomato', quantity: '2' }, { name: 'onion', quantity: '1' }, { name: 'carrot', quantity: '1' }, { name: 'beans', quantity: 'handful' }, { name: 'turmeric' }, { name: 'sambar powder' }, { name: 'tamarind', quantity: 'small piece', optional: true }],
  ...
  r('paratha-paneer', 'Paneer Paratha', 'indian', ['breakfast', 'lunch'], 15, 15, ['north_indian', 'vegetarian'],
    [{ name: 'flour', quantity: '2 cups atta' }, { name: 'paneer', quantity: '200g' }, { name: 'onion', quantity: '1 small' }, { name: 'chili', quantity: '1' }, { name: 'coriander' }, { name: 'salt' }, { name: 'oil' }],
  ...
  r('avocado-toast', 'Avocado Toast', 'american', ['breakfast'], 5, 5, ['quick', 'vegetarian'],
    [{ name: 'bread', quantity: '4 slices' }, { name: 'avocado', quantity: '2' }, { name: 'lemon' }, { name: 'salt' }, { name: 'pepper' }],
  ...
  r('scrambled-eggs', 'Fluffy Scrambled Eggs', 'american', ['breakfast'], 3, 5, ['quick', 'protein', 'kid_friendly'],
    [{ name: 'egg', quantity: '4' }, { name: 'butter', quantity: '1 tbsp' }, { name: 'milk', quantity: '2 tbsp' }, { name: 'salt' }, { name: 'pepper' }],
  ...
  r('pancakes', 'Classic Pancakes', 'american', ['breakfast'], 10, 15, ['kid_friendly', 'vegetarian'],
    [{ name: 'flour', quantity: '1.5 cups' }, { name: 'milk', quantity: '1.25 cups' }, { name: 'egg', quantity: '1' }, { name: 'sugar', quantity: '2 tbsp' }, { name: 'butter', quantity: '2 tbsp' }, { name: 'baking powder', quantity: '2 tsp' }],
    ['Mix dry ingredients.', 'Whisk in wet ingredients.', 'Cook on griddle until golden.'], { vegetarian: true }),

  r('smoothie-bowl', 'Berry Smoothie Bowl', 'american', ['breakfast', 'snack'], 5, 0, ['healthy', 'vegetarian', 'no_cook'],
  ...
  r('dal-rice', 'Simple Dal Rice', 'indian', ['lunch', 'dinner'], 10, 25, ['comfort', 'vegetarian', 'one_pot'],
    [{ name: 'lentil', quantity: '1 cup moong dal' }, { name: 'rice', quantity: '2 cups' }, { name: 'onion', quantity: '1' }, { name: 'tomato', quantity: '2' }, { name: 'turmeric' }, { name: 'cumin' }, { name: 'garlic' }, { name: 'oil' }, { name: 'salt' }],
  ...
  r('rajma-chawal', 'Rajma Chawal', 'indian', ['lunch', 'dinner'], 15, 40, ['north_indian', 'comfort', 'vegetarian'],
    [{ name: 'lentil', quantity: '1.5 cups kidney beans' }, { name: 'rice', quantity: '2 cups' }, { name: 'onion', quantity: '2' }, { name: 'tomato', quantity: '3' }, { name: 'ginger' }, { name: 'garlic' }, { name: 'cumin' }, { name: 'chili' }, { name: 'oil' }],
  ...
  r('chicken-curry', 'Home-style Chicken Curry', 'indian', ['lunch', 'dinner'], 15, 35, ['protein', 'one_pot'],
    [{ name: 'chicken', quantity: '500g' }, { name: 'onion', quantity: '2' }, { name: 'tomato', quantity: '2' }, { name: 'yogurt', quantity: '1/2 cup' }, { name: 'ginger' }, { name: 'garlic' }, { name: 'turmeric' }, { name: 'cumin' }, { name: 'chili' }, { name: 'oil' }],
  ...
  r('veg-biryani', 'Vegetable Biryani', 'indian', ['lunch', 'dinner'], 20, 40, ['festive', 'vegetarian', 'one_pot'],
    [{ name: 'rice', quantity: '2 cups basmati' }, { name: 'potato', quantity: '2' }, { name: 'carrot', quantity: '2' }, { name: 'beans', quantity: '1 cup' }, { name: 'onion', quantity: '2' }, { name: 'yogurt', quantity: '1/2 cup' }, { name: 'biryani masala' }, { name: 'oil' }],
  ...
  r('palak-paneer', 'Palak Paneer', 'indian', ['lunch', 'dinner'], 15, 20, ['north_indian', 'vegetarian', 'healthy'],
    [{ name: 'spinach', quantity: '500g' }, { name: 'paneer', quantity: '200g' }, { name: 'onion', quantity: '1' }, { name: 'tomato', quantity: '1' }, { name: 'garlic' }, { name: 'ginger' }, { name: 'cream', quantity: '2 tbsp', optional: true }, { name: 'oil' }],
  ...
  r('chana-masala', 'Chana Masala', 'indian', ['lunch', 'dinner'], 10, 25, ['vegetarian', 'protein', 'one_pot'],
    [{ name: 'lentil', quantity: '2 cups chickpeas' }, { name: 'onion', quantity: '2' }, { name: 'tomato', quantity: '3' }, { name: 'ginger' }, { name: 'garlic' }, { name: 'cumin' }, { name: 'chili' }, { name: 'oil' }],
  ...
  r('sambar-rice', 'Sambar Rice', 'indian', ['lunch', 'dinner'], 10, 30, ['south_indian', 'vegetarian'],
    [{ name: 'rice', quantity: '2 cups' }, { name: 'lentil', quantity: '1/2 cup toor dal' }, { name: 'drumstick', quantity: '2', optional: true }, { name: 'carrot', quantity: '1' }, { name: 'beans', quantity: 'handful' }, { name: 'tamarind' }, { name: 'sambar powder' }],
  ...
  r('lemon-rice', 'Lemon Rice', 'indian', ['lunch', 'dinner'], 5, 15, ['south_indian', 'quick', 'vegetarian'],
    [{ name: 'rice', quantity: '3 cups cooked' }, { name: 'lemon', quantity: '2' }, { name: 'peanut', quantity: '2 tbsp' }, { name: 'mustard seeds' }, { name: 'turmeric' }, { name: 'oil' }, { name: 'chili' }],
  ...
  r('fried-rice', 'Veg Fried Rice', 'asian', ['lunch', 'dinner'], 10, 15, ['quick', 'one_pan', 'vegetarian'],
    [{ name: 'rice', quantity: '3 cups cooked' }, { name: 'carrot', quantity: '1' }, { name: 'beans', quantity: '1/2 cup' }, { name: 'bell pepper', quantity: '1' }, { name: 'onion', quantity: '1' }, { name: 'soy sauce' }, { name: 'oil' }, { name: 'garlic' }],
  ...
  r('chicken-fried-rice', 'Chicken Fried Rice', 'asian', ['lunch', 'dinner'], 10, 15, ['quick', 'one_pan', 'protein'],
    [{ name: 'rice', quantity: '3 cups cooked' }, { name: 'chicken', quantity: '300g' }, { name: 'egg', quantity: '2' }, { name: 'carrot', quantity: '1' }, { name: 'beans', quantity: '1/2 cup' }, { name: 'soy sauce' }, { name: 'oil' }, { name: 'garlic' }],
  ...
  r('noodles-stirfry', 'Garlic Noodle Stir Fry', 'asian', ['lunch', 'dinner'], 10, 12, ['quick', 'vegetarian'],
    [{ name: 'pasta', quantity: '300g noodles' }, { name: 'garlic', quantity: '4 cloves' }, { name: 'soy sauce' }, { name: 'bell pepper', quantity: '1' }, { name: 'carrot', quantity: '1' }, { name: 'oil' }],
  ...
  r('pad-thai-simple', 'Simple Pad Thai', 'asian', ['lunch', 'dinner'], 15, 15, ['quick'],
    [{ name: 'pasta', quantity: '250g rice noodles' }, { name: 'egg', quantity: '2' }, { name: 'tofu', quantity: '200g', optional: true }, { name: 'bean sprouts', quantity: '1 cup', optional: true }, { name: 'soy sauce' }, { name: 'peanut', quantity: '2 tbsp' }, { name: 'lime' }],
  ...
  r('pasta-marinara', 'Pasta Marinara', 'italian', ['lunch', 'dinner'], 5, 20, ['quick', 'kid_friendly', 'vegetarian'],
    [{ name: 'pasta', quantity: '400g' }, { name: 'tomato', quantity: '4' }, { name: 'garlic', quantity: '3 cloves' }, { name: 'olive oil' }, { name: 'basil', quantity: 'handful', optional: true }, { name: 'salt' }],
  ...
  r('pasta-alfredo', 'Creamy Pasta Alfredo', 'italian', ['lunch', 'dinner'], 10, 15, ['comfort', 'kid_friendly', 'vegetarian'],
    [{ name: 'pasta', quantity: '400g' }, { name: 'cream', quantity: '1 cup' }, { name: 'butter', quantity: '3 tbsp' }, { name: 'garlic', quantity: '2 cloves' }, { name: 'cheese', quantity: '1/2 cup parmesan' }],
  ...
  r('spaghetti-bolognese', 'Spaghetti Bolognese', 'italian', ['lunch', 'dinner'], 15, 35, ['comfort', 'kid_friendly'],
    [{ name: 'pasta', quantity: '400g spaghetti' }, { name: 'chicken', quantity: '400g mince', optional: true }, { name: 'lentil', quantity: '1 cup', optional: true }, { name: 'tomato', quantity: '3' }, { name: 'onion', quantity: '1' }, { name: 'garlic' }, { name: 'olive oil' }],
  ...
  r('margherita-pizza', 'Homemade Margherita Pizza', 'italian', ['lunch', 'dinner'], 20, 15, ['kid_friendly', 'vegetarian'],
    [{ name: 'flour', quantity: '2 cups' }, { name: 'yeast', quantity: '1 tsp' }, { name: 'tomato', quantity: '2' }, { name: 'cheese', quantity: '200g mozzarella' }, { name: 'olive oil' }, { name: 'basil', optional: true }],
  ...
  r('greek-salad', 'Greek Salad Bowl', 'mediterranean', ['lunch', 'dinner'], 15, 0, ['healthy', 'no_cook', 'vegetarian'],
    [{ name: 'tomato', quantity: '3' }, { name: 'cucumber', quantity: '1' }, { name: 'onion', quantity: '1/2' }, { name: 'bell pepper', quantity: '1' }, { name: 'cheese', quantity: '100g feta' }, { name: 'olive oil' }, { name: 'lemon' }],
  ...
  r('hummus-wrap', 'Hummus Veggie Wrap', 'mediterranean', ['lunch', 'snack'], 10, 0, ['quick', 'vegetarian', 'no_cook'],
    [{ name: 'bread', quantity: '4 tortillas' }, { name: 'lentil', quantity: '1 cup hummus' }, { name: 'cucumber', quantity: '1' }, { name: 'tomato', quantity: '2' }, { name: 'spinach', quantity: '1 cup' }],
  ...
  r('shakshuka', 'Shakshuka', 'mediterranean', ['breakfast', 'lunch'], 10, 20, ['one_pan', 'vegetarian'],
    [{ name: 'egg', quantity: '4' }, { name: 'tomato', quantity: '4' }, { name: 'bell pepper', quantity: '1' }, { name: 'onion', quantity: '1' }, { name: 'garlic' }, { name: 'cumin' }, { name: 'olive oil' }],
  ...
  r('falafel-bowl', 'Falafel Rice Bowl', 'mediterranean', ['lunch', 'dinner'], 15, 20, ['vegetarian', 'protein'],
    [{ name: 'lentil', quantity: '1 cup chickpeas' }, { name: 'onion', quantity: '1' }, { name: 'garlic' }, { name: 'cumin' }, { name: 'coriander' }, { name: 'rice', quantity: '2 cups cooked' }, { name: 'yogurt', quantity: '1/2 cup' }, { name: 'oil' }],
  ...
  r('grilled-chicken-salad', 'Grilled Chicken Salad', 'american', ['lunch', 'dinner'], 10, 15, ['healthy', 'protein'],
    [{ name: 'chicken', quantity: '400g' }, { name: 'spinach', quantity: '4 cups' }, { name: 'tomato', quantity: '2' }, { name: 'cucumber', quantity: '1' }, { name: 'lemon' }, { name: 'olive oil' }],
  ...
  r('quesadilla', 'Cheese Quesadilla', 'mexican', ['lunch', 'snack'], 5, 10, ['quick', 'kid_friendly', 'vegetarian'],
    [{ name: 'bread', quantity: '4 tortillas' }, { name: 'cheese', quantity: '2 cups' }, { name: 'bell pepper', quantity: '1', optional: true }, { name: 'onion', quantity: '1/2', optional: true }],
  ...
  r('bean-tacos', 'Black Bean Tacos', 'mexican', ['lunch', 'dinner'], 10, 15, ['quick', 'vegetarian'],
    [{ name: 'lentil', quantity: '2 cups black beans' }, { name: 'bread', quantity: '8 taco shells' }, { name: 'tomato', quantity: '2' }, { name: 'onion', quantity: '1' }, { name: 'cheese', quantity: '1 cup', optional: true }, { name: 'lime' }],
  ...
  r('burrito-bowl', 'Chicken Burrito Bowl', 'mexican', ['lunch', 'dinner'], 15, 25, ['protein', 'one_bowl'],
    [{ name: 'rice', quantity: '2 cups' }, { name: 'chicken', quantity: '400g' }, { name: 'lentil', quantity: '1 cup black beans' }, { name: 'tomato', quantity: '2' }, { name: 'onion', quantity: '1' }, { name: 'cheese', quantity: '1 cup' }, { name: 'lime' }],
  ...
  r('tomato-soup', 'Creamy Tomato Soup', 'american', ['lunch', 'dinner'], 10, 25, ['comfort', 'vegetarian', 'kid_friendly'],
    [{ name: 'tomato', quantity: '6' }, { name: 'onion', quantity: '1' }, { name: 'garlic' }, { name: 'cream', quantity: '1/4 cup' }, { name: 'butter' }, { name: 'stock', quantity: '2 cups' }],
  ...
  r('grilled-cheese', 'Grilled Cheese Sandwich', 'american', ['lunch', 'snack'], 5, 10, ['quick', 'kid_friendly', 'vegetarian'],
    [{ name: 'bread', quantity: '4 slices' }, { name: 'cheese', quantity: '4 slices' }, { name: 'butter', quantity: '2 tbsp' }],
  ...
  r('mac-cheese', 'Stovetop Mac and Cheese', 'american', ['lunch', 'dinner'], 5, 15, ['kid_friendly', 'comfort', 'vegetarian'],
    [{ name: 'pasta', quantity: '300g macaroni' }, { name: 'cheese', quantity: '2 cups cheddar' }, { name: 'milk', quantity: '1 cup' }, { name: 'butter', quantity: '2 tbsp' }, { name: 'flour', quantity: '2 tbsp' }],
  ...
  r('chicken-soup', 'Chicken Veg Soup', 'american', ['lunch', 'dinner'], 15, 35, ['comfort', 'healthy'],
    [{ name: 'chicken', quantity: '300g' }, { name: 'carrot', quantity: '2' }, { name: 'celery', quantity: '2 stalks', optional: true }, { name: 'onion', quantity: '1' }, { name: 'stock', quantity: '6 cups' }, { name: 'garlic' }],
  ...
  r('stir-fry-tofu', 'Tofu Stir Fry', 'asian', ['lunch', 'dinner'], 10, 15, ['vegetarian', 'protein', 'quick'],
    [{ name: 'tofu', quantity: '400g' }, { name: 'bell pepper', quantity: '2' }, { name: 'broccoli', quantity: '2 cups', optional: true }, { name: 'soy sauce' }, { name: 'garlic' }, { name: 'ginger' }, { name: 'oil' }],
  ...
  r('mushroom-risotto', 'Mushroom Risotto', 'italian', ['lunch', 'dinner'], 10, 30, ['comfort', 'vegetarian'],
    [{ name: 'rice', quantity: '1.5 cups arborio' }, { name: 'mushroom', quantity: '300g' }, { name: 'onion', quantity: '1' }, { name: 'stock', quantity: '4 cups' }, { name: 'cheese', quantity: '1/2 cup parmesan' }, { name: 'butter' }],
  ...
  r('egg-fried-noodles', 'Egg Hakka Noodles', 'asian', ['lunch', 'dinner'], 10, 12, ['quick'],
    [{ name: 'pasta', quantity: '300g hakka noodles' }, { name: 'egg', quantity: '3' }, { name: 'cabbage', quantity: '2 cups', optional: true }, { name: 'carrot', quantity: '1' }, { name: 'soy sauce' }, { name: 'oil' }],
  ...
  r('khichdi', 'Moong Dal Khichdi', 'indian', ['lunch', 'dinner'], 5, 25, ['comfort', 'vegetarian', 'one_pot', 'kid_friendly'],
    [{ name: 'rice', quantity: '1 cup' }, { name: 'lentil', quantity: '1/2 cup moong dal' }, { name: 'turmeric' }, { name: 'cumin' }, { name: 'ginger' }, { name: 'ghee', quantity: '2 tbsp', optional: true }, { name: 'salt' }],
  ...
  r('aloo-gobi', 'Aloo Gobi', 'indian', ['lunch', 'dinner'], 10, 25, ['vegetarian', 'north_indian'],
    [{ name: 'potato', quantity: '3' }, { name: 'cauliflower', quantity: '1 head' }, { name: 'onion', quantity: '1' }, { name: 'tomato', quantity: '1' }, { name: 'turmeric' }, { name: 'cumin' }, { name: 'chili' }, { name: 'oil' }],
  ...
  r('baingan-bharta', 'Baingan Bharta', 'indian', ['lunch', 'dinner'], 10, 30, ['vegetarian', 'north_indian'],
    [{ name: 'eggplant', quantity: '2 large' }, { name: 'onion', quantity: '2' }, { name: 'tomato', quantity: '2' }, { name: 'garlic' }, { name: 'ginger' }, { name: 'cumin' }, { name: 'oil' }],
  ...
  r('fish-curry', 'Quick Fish Curry', 'indian', ['lunch', 'dinner'], 10, 20, ['coastal', 'protein'],
    [{ name: 'fish', quantity: '500g', optional: true }, { name: 'coconut', quantity: '1 cup milk' }, { name: 'tomato', quantity: '2' }, { name: 'onion', quantity: '1' }, { name: 'turmeric' }, { name: 'chili' }, { name: 'oil' }],
  ...
  r('egg-curry', 'Egg Curry', 'indian', ['lunch', 'dinner'], 10, 20, ['protein', 'budget'],
    [{ name: 'egg', quantity: '6' }, { name: 'onion', quantity: '2' }, { name: 'tomato', quantity: '2' }, { name: 'ginger' }, { name: 'garlic' }, { name: 'turmeric' }, { name: 'cumin' }, { name: 'oil' }],
  ...
  r('miso-soup', 'Miso Soup with Tofu', 'asian', ['lunch', 'dinner', 'snack'], 5, 10, ['light', 'vegetarian', 'quick'],
    [{ name: 'tofu', quantity: '200g' }, { name: 'miso paste', quantity: '2 tbsp' }, { name: 'stock', quantity: '4 cups' }, { name: 'seaweed', quantity: '1 sheet', optional: true }, { name: 'green onion', quantity: '2', optional: true }],
  ...
  r('caprese-salad', 'Caprese Salad', 'italian', ['lunch', 'snack'], 10, 0, ['no_cook', 'vegetarian'],
    [{ name: 'tomato', quantity: '4' }, { name: 'cheese', quantity: '200g mozzarella' }, { name: 'basil', quantity: 'handful' }, { name: 'olive oil' }, { name: 'balsamic', quantity: '1 tbsp', optional: true }],
  ...
  r('peanut-butter-sandwich', 'PB Banana Sandwich', 'american', ['breakfast', 'snack'], 3, 0, ['no_cook', 'kid_friendly', 'quick'],
    [{ name: 'bread', quantity: '2 slices' }, { name: 'peanut_butter', quantity: '2 tbsp' }, { name: 'banana', quantity: '1' }, { name: 'honey', quantity: '1 tsp', optional: true }],
    ['Spread peanut butter on bread.', 'Add banana slices.', 'Drizzle honey if desired.']),

  r('fruit-parfait', 'Yogurt Fruit Parfait', 'american', ['breakfast', 'snack'], 5, 0, ['no_cook', 'healthy', 'vegetarian'],
  ...
  r('veggie-omelette', 'Veggie Loaded Omelette', 'american', ['breakfast', 'lunch'], 5, 10, ['quick', 'protein', 'vegetarian'],
    [{ name: 'egg', quantity: '3' }, { name: 'bell pepper', quantity: '1/2' }, { name: 'spinach', quantity: '1 cup' }, { name: 'onion', quantity: '1/4' }, { name: 'cheese', quantity: '1/4 cup', optional: true }, { name: 'butter' }],
  ...
  r('chicken-wrap', 'Chicken Caesar Wrap', 'american', ['lunch', 'snack'], 10, 10, ['quick', 'protein'],
    [{ name: 'chicken', quantity: '300g' }, { name: 'bread', quantity: '4 tortillas' }, { name: 'spinach', quantity: '2 cups' }, { name: 'yogurt', quantity: '1/4 cup' }, { name: 'lemon' }],
  ...
  r('potato-wedges', 'Baked Potato Wedges', 'american', ['snack', 'dinner'], 10, 30, ['kid_friendly', 'vegetarian'],
    [{ name: 'potato', quantity: '4 large' }, { name: 'oil', quantity: '3 tbsp' }, { name: 'salt' }, { name: 'pepper' }, { name: 'paprika', quantity: '1 tsp', optional: true }],
    ['Cut potatoes into wedges.', 'Toss with oil and spices.', 'Bake until crispy.'], { vegetarian: true }),

  r('mug-cake', 'Microwave Mug Cake', 'american', ['snack'], 3, 2, ['quick', 'dessert', 'vegetarian'],
    [{ name: 'flour', quantity: '4 tbsp' }, { name: 'sugar', quantity: '3 tbsp' }, { name: 'cocoa', quantity: '2 tbsp', optional: true }, { name: 'milk', quantity: '3 tbsp' }, { name: 'oil', quantity: '2 tbsp' }],
    ['Mix ingredients in mug.', 'Microwave 90 seconds.'], { vegetarian: true }),

  r('banana-smoothie', 'Banana Peanut Smoothie', 'american', ['breakfast', 'snack'], 3, 0, ['no_cook', 'quick'],
  ...
  r('coconut-rice', 'Coconut Rice', 'indian', ['lunch', 'dinner'], 5, 20, ['south_indian', 'vegetarian'],
    [{ name: 'rice', quantity: '2 cups' }, { name: 'coconut', quantity: '1 cup milk' }, { name: 'oil' }, { name: 'mustard seeds' }, { name: 'curry leaves', quantity: 'handful', optional: true }],
  ...
  r('tadka-dal', 'Tadka Dal', 'indian', ['lunch', 'dinner'], 5, 25, ['comfort', 'vegetarian', 'budget'],
    [{ name: 'lentil', quantity: '1 cup toor dal' }, { name: 'onion', quantity: '1' }, { name: 'tomato', quantity: '1' }, { name: 'garlic' }, { name: 'cumin' }, { name: 'turmeric' }, { name: 'chili' }, { name: 'ghee', quantity: '1 tbsp' }],
  ...
  r('veg-pulao', 'Mixed Veg Pulao', 'indian', ['lunch', 'dinner'], 10, 25, ['one_pot', 'vegetarian'],
    [{ name: 'rice', quantity: '2 cups' }, { name: 'carrot', quantity: '1' }, { name: 'beans', quantity: '1/2 cup' }, { name: 'peas', quantity: '1/2 cup', optional: true }, { name: 'onion', quantity: '1' }, { name: 'cumin' }, { name: 'oil' }],
  ...
  r('butter-chicken', 'Butter Chicken', 'indian', ['lunch', 'dinner'], 20, 30, ['north_indian', 'festive'],
    [{ name: 'chicken', quantity: '500g' }, { name: 'tomato', quantity: '4' }, { name: 'cream', quantity: '1/2 cup' }, { name: 'butter', quantity: '3 tbsp' }, { name: 'yogurt', quantity: '1/2 cup' }, { name: 'ginger' }, { name: 'garlic' }, { name: 'garam masala' }],
  ...
  r('dosa-potato', 'Masala Dosa Filling', 'indian', ['breakfast', 'lunch'], 15, 20, ['south_indian', 'vegetarian'],
    [{ name: 'potato', quantity: '4' }, { name: 'onion', quantity: '2' }, { name: 'mustard seeds' }, { name: 'turmeric' }, { name: 'curry leaves', optional: true }, { name: 'oil' }],
  ...
  r('chicken-tikka', 'Pan Chicken Tikka', 'indian', ['lunch', 'dinner'], 15, 20, ['protein', 'grilled'],
    [{ name: 'chicken', quantity: '500g' }, { name: 'yogurt', quantity: '1 cup' }, { name: 'ginger' }, { name: 'garlic' }, { name: 'lemon' }, { name: 'tikka masala' }, { name: 'oil' }],
